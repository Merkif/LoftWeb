...
/* harmony import */ var _components_header_height__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/header-height */ "./src/js/components/header-height.js");
/* harmony import */ var _components_header_height__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_header_height__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _components_theme_switcher__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/theme-switcher */ "./src/js/components/theme-switcher.js");
/* harmony import */ var _components_theme_switcher__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_theme_switcher__WEBPACK_IMPORTED_MODULE_3__);
...
/***/ "./src/js/components/ScrollSmoother.min.js":
/*!*************************************************!*\
  !*** ./src/js/components/ScrollSmoother.min.js ***!
  \*************************************************/
...
/* harmony import */ var _ScrollSmoother_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ScrollSmoother.min.js */ "./src/js/components/ScrollSmoother.min.js");
/* harmony import */ var _ScrollSmoother_min_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_ScrollSmoother_min_js__WEBPACK_IMPORTED_MODULE_0__);



gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger, _ScrollSmoother_min_js__WEBPACK_IMPORTED_MODULE_0__.ScrollSmoother);

//scroll Smoother
if (gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.isTouch !== 1) {
  let smoother = _ScrollSmoother_min_js__WEBPACK_IMPORTED_MODULE_0__.ScrollSmoother.create({
    wrapper: '.viewport',
...
let mm = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.matchMedia();
const sectionHeroTimeLine = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.timeline();
const sectionHeroTitle = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.utils.toArray('.section-hero__title *');
let scrollTween = null;
const horizontalSections = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.utils.toArray('.horizontal-scroll');
const cases = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.utils.toArray('.case');
const marqueeLight = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.utils.toArray('.marquee__item--light');
const marqueeDark = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.utils.toArray('.marquee__item--dark');
...
const clientCards = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.utils.toArray('.client-card');
const ratingCards = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.utils.toArray('.rating-card');
...
const headerImg = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.utils.toArray('.c-header__img, .c-header__grid');
...
mm.add({
  ...
  if (context.conditions.isDesktop) {
    //cursor
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set('.custom-cursor__follower', {
      xPercent: -50,
      yPercent: -50
    });
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set('.custom-cursor__cursor', {
      xPercent: -50,
      yPercent: -50
    });
    window.addEventListener('mousemove', e => {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(cursorFollower, {
        x: clientX,
        y: clientY,
        duration: .4,
        ease: "sine.out"
    ...
    horizontalSections.forEach(function (sec, i) {
      ...
      scrollTween = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.fromTo(thisAnimWrap, {
    ...
    cases.forEach(item => {
      ...
      const caseTimeLine = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.timeline({
        scrollTrigger: {
          trigger: item,
          containerAnimation: scrollTween,
          scrub: 0,
      ...
      gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.fromTo(caseContent, {
        x: 200
      }, {
        x: -110,
        ease: "none",
    ...
    function createMarqueeAnimation(item, x, animationType) {
      ...
      if (animationType === 'from') {
        gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.from(track, animationParams);
      } else if (animationType === 'to') {
        gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(track, animationParams);
      }
    }
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.from(sectionServicesImg, {
      x: 300,
      ease: "none",
      scrollTrigger: {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(sectionServicesList, {
    ...
    //section clients
    const clientCardsStagger = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.from(clientCards, {
      opacity: 0,
      duration: 1.5,
      ease: "power4.out",
      stagger: {
    ...
    const ratingCardsStagger = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.from(ratingCards, {
      opacity: 0,
      duration: 1.2,
      ease: "power4.out",
      stagger: {
...
let lazyLoadInstance = new (vanilla_lazyload__WEBPACK_IMPORTED_MODULE_0___default())({});
...
resizableSwiper('(max-width: 1024px)', '.swiper--clients', {
...
resizableSwiper('(max-width: 1024px)', '.swiper--rating', {
  modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation],
  spaceBetween: 24,
  slidesPerView: 1.3,
  centeredSlidesBounds: true,
